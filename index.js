...
(async () => {
  try {
    ...
    youtubeItems = responseYoutube.data.items;
    ...
    const youtubePost1 = `<a href="https://www.youtube.com/watch?v=${youtubeItems[0].id.videoId}" target='_blank'>
     <img width='30%' src="${youtubeItems[0].snippet.thumbnails.high.url}" alt="${youtubeItems[0].title}" />
   </a>`;
    const youtubePost2 = `<a href="https://www.youtube.com/watch?v=${youtubeItems[1].id.videoId}" target='_blank'>
     <img width='30%' src="${youtubeItems[1].snippet.thumbnails.high.url}" alt="${youtubeItems[1].title}" />
   </a>`;
